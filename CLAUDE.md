...
This is a PlatformIO-based ESP32-S3 display project for the JC3248W535EN development board with a 3.5-inch capacitive touch LCD (320×480 resolution). It's a port of the manufacturer's Arduino demo code to ESP-IDF 5.3, required because the AXS15231B display driver uses ESP-IDF 5.3 APIs not available in Arduino ESP32 (ESP-IDF 4.x).
...
pio device monitor -e LVGL-320-480

# Build and upload
pio run -e LVGL-320-480 -t upload && pio device monitor -e LVGL-320-480
...
- `src/CMakeLists.txt` auto-generated by PlatformIO
...
- `LV_CONF_PATH` - Overrides default LVGL config location
